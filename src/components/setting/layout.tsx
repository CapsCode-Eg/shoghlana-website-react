...
export default function Layout({ children }: { children: React.ReactNode }) {
    ...
    return (
        <div className="flex flex-col font-inter  overflow-hidden max-w-screen bg-[#f5f5f5]">
            <NavbarTwo />
            <div className="flex flex-col min-h-[60vh] lg:flex-row w-[95%] xl:w-[80%] mx-auto justify-center xl:justify-between gap-[5px] main-body min-w-screen pb-[27px] pt-[10px] xl:pt-[calc(64px+32px)]">

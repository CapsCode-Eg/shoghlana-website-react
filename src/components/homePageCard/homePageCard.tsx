        ...
        <blockquote className="min-w-[430px]">
            ...
            <div className="mt-4 flex flex-col">
                ...
                <div className='flex flex-row mt-12 gap-4 items-center'>
                    <img width={60} height={45} className='object-cover rounded-full w-[66px] h-[66px]' src={'https://images.unsplash.com/photo-1544005313-94ddf0286df2?q=80&w=1376&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D'} alt='Profile Icon' />

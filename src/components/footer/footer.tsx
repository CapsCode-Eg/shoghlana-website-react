         ...
         bg-main my-[10px] overflow-hidden '>
            ...
            <div className="mx-auto pt-[35px] px-[20px] md:px-[40px] pb-[16px] relative z-[6]">
                <div className="grid grid-cols-1 xl:grid-cols-5 gap-10">
                    ...
                    <div className="flex flex-col col-span-2">
                        <div className="flex items-center space-x-2">
                            <div className="bg-white rounded-full w-[95px] h-[95px] flex flex-col items-center justify-center">
                                <img width={50} height={50} src="/assets/logoBlue.png" alt="Logo" className="w-[89.19px] h-[39.87px] object-contain" />
                            </div>
                        </div>
                    ...
                    {/* Links */}
                    <div className="grid col-span-3 grid-cols-2 md:grid-cols-4 gap-10 mt-4 relative z-[6]">
                        <div>
                        ...
                        <div className="col-span-2">
                            ...
                            <div className="flex flex-row items-center w-full justify-between">
                                <Link to={data?.facebook} className="hover:opacity-75">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <g clipPath="url(#clip0_3_4960)">
                                ...
                                <Link to={data?.instagram} className="hover:opacity-75">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <Link to={data?.linkedin} className="hover:opacity-75">
                                    <svg
                                ...
                                <Link to={data?.youtube} className="hover:opacity-75">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">

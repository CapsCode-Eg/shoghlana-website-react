                            ...
                            {isEditing ? (
                                <div className="flex flex-col">
                                    <div className='flex flex-col relative w-full '>
                                        ...
                                        <CustomSelectMenu defaultData={item?.years_of_experience} error={errors?.years_of_experience} options={[{ id: 1, name: "1" }, { id: 2, name: '2' }, { id: 3, name: '3' }, { id: 4, name: '4' }, { id: 5, name: '5' }]} onChange={(e: any) => handleChange(item.id, "years_of_experience", e.id)} />
                                ...
                                < >
                                    <div className='flex flex-col relative w-full'>
                                        ...
                                        <div className='grid grid-cols-2 w-full gap-5 mt-4'>
                                            <InputAndLabel disabled value={item?.experience_job_title} error={errors?.experience_job_title} label="Job title" placeholder="Job title" normalChange onChange={(e) => handleChange(item.id, "job_title", e.target.value)} name='job_title' />
